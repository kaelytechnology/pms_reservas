...
class Decoration extends BaseModel
{
     ...
     * @var string
     */
    protected $table = 'pms_decorations';
    ...
    {
        return [
            'name' => ['required', 'string', 'max:255', 'unique:pms_decorations,name'],
    ...
    /**
     * Scope a query to search decorations.
     *
     * @param Builder $query
     * @param string $search
     * @return Builder
    ...
    /**
     * Get the restaurant reservations for the decoration.
     */
